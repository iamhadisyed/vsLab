    ...
    jm.prototype = {
        ...
        dblclick_handle: function (e) {
            ...
            if (this.get_editable()) {
                ...
                var nodeid = this.view.get_binded_nodeid(element);
                if (!!nodeid) {
                    window.open("https://www.thothlab.com/content/conceptmap#"+nodeid,"_blank");
                }
        ...
        select_node: function (node,topPos) {
            if (!jm.util.is_node(node)) {
                var the_node = this.get_node(node);
                if (!the_node) {
                    logger.error('the node[id=' + node + '] can not be found.');
                    ...
                    return this.select_node(the_node,topPos);
                }
            }
            ...
            this.view.select_node(node,topPos);
        ...
        create_node_element: function (node, parent_node) {
            ...
            if (node.isroot) {
                ...
                if('data' in node.data){
                    d.setAttribute('title', node.data.data.desc);
                    d.className = 'tooltip1';
                }
            }
            if (!!node.topic) {
            ...
            if (!!this.selected_node) {
                ...
                if(typeof topPos !== "undefined"){
                    ...
                    if (this.size.w > outer_w) {
                        ...
                        this.e_panel.scrollLeft = outer_w / 2;
                    }
                    if (this.size.h > outer_h) {
                        this.e_panel.scrollTop = topPos-200;
                    }
                }
