...
$(document).ready(function () {
    ...
    $.getJSON("/cloud/getWallPaper", function (jdata) {
        var wallpaper = jdata.wall_paper;
        if (wallpaper.length == null) {
            set_wallpaper($('#wallpaper_select').find('a[name*="default"]'), 'default');
        } else {
            set_wallpaper($('#wallpaper_select').find('a[name*="' + wallpaper + '"]'), wallpaper);
        }
    });
    ...
    $.wakeUp(function(sleep_time) {
        var slept = sleep_time / 1000;
        if (slept > 300) { // 5mins
            alert("Your computer have slept for " + slept + " seconds");
            //window.location.reload();
            $('a.user.logout')[0].click();
        }
    });
...
function load_window_content(winId) {
    ...
    if (winId == '#window_projectlist') {
        ...
        windows_group_display(winId, win_main);
        ...
        links.append(
            "<div>" +
            "<br><legend style='font-weight: bold;font-size: larger; text-align:center'>Introduction:</legend> <div style='text-align:center;'><br><iframe id='ytplayer1' type='text/html' width='480' height='300' src='https://www.youtube.com/embed/pmZk3MT-55I?autoplay=0' frameborder='0' allowfullscreen/><br>" +
            "</div><br><br><div style='text-align:center;font-size: medium'><br><legend style='font-weight: bold'>My Labs</legend><br><iframe id='ytplayer2' type='text/html' width='480' height='300' src='https://www.youtube.com/embed/JnGQUxXXuRw?autoplay=0' frameborder='0' allowfullscreen/>" +
            "<br><iframe id='ytplayer2' type='text/html' width='480' height='300' src='https://www.youtube.com/embed/7V7jwfgv4nE?autoplay=0' frameborder='0' allowfullscreen/>" +
            "<br><iframe id='ytplayer2' type='text/html' width='480' height='300' src='https://www.youtube.com/embed/pCErq1fARW0?autoplay=0' frameborder='0' allowfullscreen/>" +
            "<br><br><br><legend style='font-weight: bold'>Open Labs:</legend><br><iframe id='ytplayer5' type='text/html' width='480' height='300' src='https://www.youtube.com/embed/cwwFZqeszOE?autoplay=0' frameborder='0' allowfullscreen/>" +
            "<br><br><br><legend style='font-weight: bold'>Group Management:</legend><br><iframe id='ytplayer5' type='text/html' width='480' height='300' src='https://www.youtube.com/embed/y_u_N6Z9bQ8?autoplay=0' frameborder='0' allowfullscreen/>" +
            "<br><br><br><legend style='font-weight: bold'>Lab Design:</legend><br><iframe id='ytplayer5' type='text/html' width='480' height='300' src='https://www.youtube.com/embed/pLdGg-gY0aY?autoplay=0' frameborder='0' allowfullscreen/>" +
            "<br><br><br><legend style='font-weight: bold'>Lab Management:</legend><br><iframe id='ytplayer5' type='text/html' width='480' height='300' src='https://www.youtube.com/embed/FerUYK1taCU?autoplay=0' frameborder='0' allowfullscreen/>" +
            "<br><br><br><legend style='font-weight: bold'>Settings:</legend><br><iframe id='ytplayer5' type='text/html' width='480' height='300' src='https://www.youtube.com/embed/ziJWSyMNU90?autoplay=0' frameborder='0' allowfullscreen/>" +
            "</div></div>"
        );
    }
    ...
    } else if (winId.substring(0, '#window_admin'.length) == '#window_admin') {
        windows_admin_display(winId, win_main);
    } else if (winId.substring(0, '#window_help'.length) == '#window_help') {
...
function populate_content_mylabs(winId, win_main) {
    ...
    $.getJSON("cloud/getWorkingLabList", function (jsondata) {

        //var roles = $("#roleprofile");

        $.each(jsondata, function (index, item) {
            if(item.group=="No Working Lab"){
                item.deployat = (new Date(item.deployat.slice(0,19).replace(' ','T') + ".000Z")).toString().replace(/ GMT.*/g,"");
                $("<tr><td><img src=" + ICON_project + "></img></td><td>" + item.group + "</td><td>" + item.team + "</td><td>" + item.lab + "</td><td>" + item.deployat + "</td><td hidden>" + item.project + "</td><td>"+item.dueat+"</td><td></td></tr>").appendTo(tbody1);
                ...
                $("<tr><td><img src=" + ICON_project + "></img></td><td>" + item.group + "</td><td>" + item.team + "</td><td>" + item.lab + "</td><td>" + item.deployat + "</td><td hidden>" + item.project + "</td><td hidden>" + item.openlab + "</td><td hidden>" + item.term +"</td><td>"+item.dueat+"</td><td class='dropdown'><a class='btn btn-default workinglab-actionButton' data-toggle='dropdown' href='#'>More <i class='fa fa-sort-down'></i></a></td></tr>").appendTo(tbody1);
...
function button_click(element) {
    ...
    switch (eid) {
        ...
        case 'submit_apply_superuserrole_class':
            ...
            break;
        case 'add_new_site':
            add_new_site(element);
            break;
        case 'post_add_site':
            post_add_site(element);
            break;
        ...
        case 'search_user_btn':
            search_user_btn();
            break;
        case 'search_user_btn_copy':
            search_user_btn_copy();
            break;
        case 'search_user_btn_copy2':
...
function get_vm_console(winId, win_main) {
    ...
    iframe_console.attr("name", "vm_console_" + vmId).attr("width", "100%").attr("style", "height: 100em")
