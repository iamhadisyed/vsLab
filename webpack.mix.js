...
mix.js('resources/assets/js/app.js', 'public/js')
   ...
   .combine([
       ...
       'public/packages/vis/dist/vis.css',
       'public/workspace-assets/css/workspace.css',
       'public/packages/waitMe/waitMe.css'
   ], 'public/css/all.css')
   .combine([
   ...
   //VENDOR RESOURCES
    .copy('public/packages/vis/dist/img/*.*', 'public/img/', false)
