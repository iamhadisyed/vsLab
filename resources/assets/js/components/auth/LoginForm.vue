<template>
 <form method="post" @submit.prevent="submit" @keydown="clearErrors($event.target.name)">
  <input type="hidden" class="form-control" name="timezone" :value="timeZone"/>
...
export default {
  ...
  data: function () {
     let form = new Form({ username: '', password: '', remember: '', timezone: '' })

     if (this.name === 'email') {
        form = new Form({email: '', password: '', remember: '', timezone: moment.tz.guess() })
     }
