<template>
 <form method="post" @submit.prevent="submit" @keydown="clearErrors($event.target.name)">
  ...
  <div class="form-group has-feedback " :class="{ 'has-error': form.errors.has('first_name') }">
   <input type="text" class="form-control" :placeholder="trans('adminlte_lang_message.firstname')" name="first_name" value="" v-model="form.first_name" autofocus/>
   ...
   <div class="form-group has-feedback " :class="{ 'has-error': form.errors.has('last_name') }">
     <input type="text" class="form-control" :placeholder="trans('adminlte_lang_message.lastname')" name="last_name" value="" v-model="form.last_name" />
     <span class="glyphicon glyphicon-user form-control-feedback"></span>
     <transition name="fade">
  ...
  <div class="form-group has-feedback" :class="{ 'has-error': form.errors.has('institute') }">
   <input type="text" class="form-control" :placeholder="trans('adminlte_lang_message.institute')" name="institute" value="" v-model="form.institute"/>
   <span class="glyphicon glyphicon-blackboard form-control-feedback"></span>
   <transition name="fade">
    <span class="help-block" v-if="form.errors.has('institute')" v-text="form.errors.get('institute')"></span>
   </transition>
  </div>
...
export default {
  ...
  data: function () {
    return {
      form: new Form({ first_name: '', last_name: '', email: '', institute: '', password: '', password_confirmation: '', terms: '' })
    }
  },
  watch: {
