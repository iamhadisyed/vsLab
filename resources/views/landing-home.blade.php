            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="intro-message">
                        <h1>ThoTh Lab V3.0</h1>
                        {{--<h3>A hands-on interactive computer lab platform <br />--}}
                          {{--<h3>  powered by Mobile Cloud Computing</h3>--}}
                        <hr class="intro-divider">
                        <ul class="list-inline intro-social-buttons">
                            <li>
                                <a href="{{ URL::route('login') }}" class="submit"><font color="white"> &nbsp;Enter</font> &nbsp;</a>
                            </li><br><br><br>
                            {{--<li>--}}
                                {{--<a href="{{ URL::asset('user/signup') }}" ><font size="3" color="white">&nbsp;First time user? Sign Up here!</font></a>--}}
                            {{--</li>--}}
                            <br><br><br>
                            <li>
                                <a href="#" id="videoLink" class="launch-modal" data-toggle="modal" data-target="#videoModal">
                                    <font size="3" color="white">
                                    <span class="video-link-icon"><i class="fa fa-play"></i></span>
                                    <span class="video-link-text">Introductory Video</span></font>
                                </a>
                            </li>
                            <br><br><br>
                            {{--<li>--}}
                                {{--<a href="#" id="service-agreement" class="launch-modal" data-toggle="modal" data-target="#service-agreement-Modal">--}}
                                    {{--<span>Service Agreement</span>--}}
                                {{--</a>--}}
                            {{--</li>--}}
                            {{--<li>--}}
                                {{--<a href="#features" class="btn btn-default btn-lg"><i class="fa fa-cubes"></i>&nbsp;<span class="network-name">Features</span></a>--}}
                            {{--</li>--}}
                            {{--<li>--}}
                                {{--<a href="#faq" class="btn btn-default btn-lg"><i class="fa fa-question-circle"></i>&nbsp;<span class="network-name">FAQ</span></a>--}}
                            {{--</li>--}}

                            {{--<li>--}}
                                {{--<a href="{{ URL::asset('mobile') }}" class="btn btn-default btn-lg"><img src="workspace-assets/images/icons/icon_24_research.png" />&nbsp;<span class="network-name">Research</span></a>--}}
                            {{--</li>--}}
                            {{--<li>--}}
                                {{--<a href="{{ URL::asset('projects') }}" class="btn btn-default btn-lg"><img src="workspace-assets/images/icons/icon_24_open.png" />&nbsp;<span class="network-name">Open Projects</span></a>--}}
                            {{--</li>--}}
                        </ul>
                    </div>
                </div>
