...
@section('content')
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-12">
                        ...
                        <h3>November 2019</h3>
                        <h3>Athena Network Solutions LLC (Athenets)</h3>
    ...
    <div>
        ...
        <p style="font-weight: 400;">
            This privacy statement explains the personal data Athena Network Solutions LLC ("Athenets", "we", "our", or "us", or its product -- a service platform called "ThoTh Lab") processes, how Athenets processes it, and for what purposes.
        </p>
        <p style="font-weight: 400;">
            ThoTh Lab provides an education service focusing on a virtualized hands-on laboratory service to enhance learning outcomes for its users. ThoTh Lab users can use a web browser to access to ThoTh Lab from anywhere as long as they Internet connections. For more detailed ThoTh Lab services provided by Athenets, please refer to the services introduction at Athenets' website.
        </p>
        <p style="font-weight: 400;">
            Please read the service-specific details in this privacy statement, which provide additional relevant information. This statement applies to the interactions Athenets has with you and the ThoTh Lab service features listed below, as well as other ThoTh Lab services that display this statement.
        </p>
        <ol>
            <li>
                <span style="font-weight: 600">Personal data we collect</span><br>
                <span style="font-weight: 400;">
Athenets uses the data we collect to provide you with rich, interactive experiences. In particular, we use data to:
                <ol type="a">
            <li>
            ...
            <li>
                ...
                <p style="font-weight: 400;">
                    In carrying out these purposes, we combine data we collect from different contexts (for example, from your use of two Athenets products) or obtain from third parties to give you a more seamless, consistent, and personalized experience, to make informed business decisions, and for other legitimate purposes.
                </p>
                <p style="font-weight: 400;">
                    Our processing of personal data for these purposes includes both automated and manual (human) methods of processing. Our automated methods often are related to and supported by our manual methods. For example, our automated methods include artificial intelligence (AI), which we think of as a set of technologies that enable computers to perceive, learn, reason, and assist in decision-making to solve problems in ways that are similar to what people do. To build, train, and improve the accuracy of our automated methods of processing (including AI), we manually review some of the predictions and inferences produced by the automated methods against the underlying data from which the predictions and inferences were made. For example, we manually review short snippets of a small sampling of users' action data in ThoTh Lab we have taken steps to assist you to improve our learning services, such as providing instant advices or guidance to you and getting better education results.
                </p>
            </li>
            <li>
                <span style="font-weight: 600">Reasons we share personal data</span><br>
                <span style="font-weight: 400">
                We share your personal data with your consent or to complete any transaction or provide any product you have requested or authorized. We also share data with Athenets-controlled affiliates and subsidiaries; with vendors working on our behalf; when required by law or to respond to legal process; to protect our customers; to protect lives; to maintain the security of our products; and to protect the rights and property of Athenets and its customers.
                </span></li>
            <li>
                <span style="font-weight: 600">How to access and control your personal data</span><br>
                <span style="font-weight: 400">You can also make choices about the collection and use of your data by Athenets. You can control your personal data that Athenets has obtained, and exercise your data protection rights, by contacting Athenets or using various tools we provide. In some cases, your ability to access or control your personal data will be limited, as required or permitted by applicable law. How you can access or control your personal data will also depend on which products you use. For example, you can:
                    <ol type="a">
                <li>Control the use of your data for interest-based advertising from Athenets by visiting our opt-out page within the users' personal profile web page.
                </li>
                <li>
                    Choose whether you wish to receive promotional emails or newsletters.
                </li>
                        <li>
                    Access and clear some of your data through the users' personal profile.
                </li>
            </ol>
                    Not all personal data processed by Athenets can be accessed or controlled via the tools above. If you want to access or control personal data processed by Athenets that is not available via the tools above or directly through the Athenets products you use, you can always contact Athenets at the address support@athenets.com.
            </span>
            </li>
            <li>
                <span style="font-weight: 600">Cookies and similar technologies</span><br>
                <span style="font-weight: 400">
                Cookies are small text files placed on your device to store data that can be recalled by a web server in the domain that placed the cookie. We use cookies and similar technologies for storing and honoring your preferences and settings, enabling you to sign in, providing interest-based advertising, combating fraud, analyzing how our products perform, and fulfilling other legitimate purposes. <br>
                    We also use "web beacons" to help deliver cookies and gather usage and performance data. Our websites may include web beacons, cookies, or similar technologies from third-party service providers.<br>
                    You have a variety of tools to control the data collected by cookies, web beacons, and similar technologies. For example, you can use controls in your internet browser to limit how the websites you visit are able to use cookies and to withdraw your consent by clearing or blocking cookies.<br>

            </span>
            </li>
            <li>
                <span style="font-weight: 600">Products provided by your organization--notice to end users</span><br>
                <span style="font-weight: 400">
                    If you use an Athenets product or use an email address to access Athenets products and that product or email address was provided by an organization you are affiliated with, such as an employer or school, that organization can:
                 <ol type="a">
            <li>
                Control and administer your Athenets product and product account, including controlling privacy-related settings of the product or product account.
            </li>
            <li>
                Access and process your data, including the interaction data, diagnostic data, and the contents of your communications and files associated with your Athenets product and product accounts.
            </li>
                ...
                <p style="font-weight: 400;">
                    If your organization provides you with access to Athenets products, your use of the Athenets products is subject to your organization's policies, if any. You should direct your privacy inquiries, including any requests to exercise your data protection rights, to your organization's administrator. Athenets is not responsible for the privacy or security practices of our customers, which may differ from those set forth in this privacy statement.
                </p>
                <span style="font-weight: 400;">
                    For Athenets products provided by K-12 school, Athenets will:
                     <ol type="a">
            <li>
            ...
            <li>
                <span style="font-weight: 600">Athenets account</span><br>
                <span style="font-weight: 400">
                    With an Athenets account, you can sign in to Athenets products, as well as those of select Athenets partners. Personal data associated with your Athenets account includes credentials, name and contact data, payment data, device and usage data, your contacts, information about your activities, and your interests and favorites. Signing in to your Athenets account enables personalization and consistent experiences across products and devices, permits you to use cloud data storage, and enables other features.<br>
            There are three types of Athenets account:
                    <ol type="a">
                <li>When you create your own Athenets account tied to your personal email address, we refer to that account as a personal Athenets account, with a normal user privilege in ThoTh Lab.
                </li>
<li>
    When you or your organization (such as an employer or your school) create your Athenets account tied to your email address provided by that organization, we refer to that account as a site or school account, which has the site-admin privilege in ThoTh Lab.
    </li>
            </ol>
                    These Athenets accounts can has their initially assigned privileges that can be increased and decreased based on the service needs or the service agreements with your organization. The list of privileges of our service provided can be viewed in the Privileges of Athenets account section.
            <br>
            </span>
                </li>
            <li>
                <span style="font-weight: 600">Privileges of Athenets account</span><br>
                <span style="font-weight: 400">Current ThoTh Lab provides the following privileges for its users:
<table class="tg" BORDER=2 BORDERCOLOR=Black>
  <tr>
    <th class="tg-0lax">Account Type</th>
    <th class="tg-0lax">Privileges</th>
    <th class="tg-0lax">Notes</th>
  </tr>
  <tr>
    <td class="tg-0lax">Normal User</td>
    <td class="tg-0lax">View open lab repository, use assigned labs, submit lab results, view<br>lab performance scores</td>
    <td class="tg-0lax"></td>
  </tr>
  <tr>
    <td class="tg-0lax">Super User</td>
    <td class="tg-0lax">This account includes all normal users' privilege. Additionally, it can<br>create Lab environment, assign labs to students, create student teams (e.g.,<br>subgroups), manage student membership within a student group</td>
    <td class="tg-0lax">Superuser is considered as a class instructor.</td>
  </tr>
  <tr>
    <td class="tg-0lax">Guest User</td>
    <td class="tg-0lax">View open lab repository and demos, use trial environments with a given<br>time period</td>
    <td class="tg-0lax"></td>
  </tr>
  <tr>
    <td class="tg-0lax">Site Admin</td>
    <td class="tg-0lax">Create student group (i.e., class), manage student membership within a<br>site, manage resources for all student groups.</td>
    <td class="tg-0lax">Site is considered as a school</td>
  </tr>
  <tr>
    <td class="tg-0lax">System Admin</td>
    <td class="tg-0lax">Manage resources for all sites.</td>
    <td class="tg-0lax">System is considered as the entire ThoTh Lab service scope.</td>
  </tr>
</table>
            </span>
            </li>
