...
<head>
    ...
    <meta name="description" content="ThoTh Lab - {{ trans('adminlte_lang::message.landingdescription') }} ">
    <meta name="author" content="James Chung - thothlab.org">

    <meta property="og:title" content="Thoth-Lab" />
    <meta property="og:type" content="website" />
    <meta property="og:description" content="ThoTh Lab - {{ trans('adminlte_lang::message.landingdescription') }}" />
    <meta property="og:url" content="https://www.thothlab.com/" />
        ...
        <div class="container">
            ...
            <div class="navbar-collapse collapse">
                ...
                <ul class="nav navbar-nav navbar-right">
                    @if (Auth::guest())
                        <li><a href="{{ url('/userlogin') }}">{{ trans('adminlte_lang::message.login') }}</a></li>
                        <li><a href="{{ url('/userregister') }}">{{ trans('adminlte_lang::message.register') }}</a></li>
                    @else
            ...
            <div class="container">
                <div class="row centered">
                    <div class="col-lg-12">
                        ...
                        <h3><a href="{{ url('/userregister') }}" class="btn btn-lg btn-success">{{ trans('adminlte_lang::message.gedstarted') }}</a></h3>
                    </div>
                    <div class="col-lg-2">
