...
<header class="main-header">
    ...
    <a href="{{ url('/userhome') }}" class="logo">
        ...
        <span class="logo-lg"><b>ThoTh</b>Lab </span>
    </a>
                    ...
                    <li class="dropdown user user-menu" id="user_menu">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-header">
                                ...
                                <p>
                                    {{ Auth::user()->name }}
                                    <small>{{ trans('adminlte_lang::message.login') }} from <span id="main_header_timezone"></span></small>
                                    <small><span id="main_header_localtime"></span></small>
                                </p>
                            </li>
                            <!-- Menu Body -->
                            {{--<li class="user-body">--}}
                            ...
                            <li class="user-footer">
                                ...
                                {{--<div class="pull-left">--}}
                                    {{--<a href="{{ url('/doc/lab-student-guide.pdf') }}" class="btn btn-default btn-flat">User Guide</a>--}}
                                {{--</div>--}}
