...
@section('main-content')
        ...
        <div class="panel panel-default">
            <div class="panel-head table-responsive" style="margin-top: 15px">
                <div class="form-group">
                    ...
                    @if ($id != 0)
                    <button  type="button" style="padding-top: 5px; padding-right: 5px; padding-bottom: 5px; padding-left: 5px" class="btn btn-warning" onclick="auto_suspending($(this))" title="Setup auto suspend for current group">Setup Auto Suspend</button>
                    @endif
    ...
    <!-- modal -->
    <div class="modal modal-default fade" id="modal-auto-suspend" data-backdrop="static">
        <div class="modal-dialog" style="width: 900px;">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                    <h4 class="modal-title"><i class="fa fa-user"></i> Set Up Auto Suspending For <span class="groupname-in-title"></span></h4>
                </div>
                <div class="modal-body">
                    <form id="form-auto-suspend" class="form-horizontal" method="POST" action="{{ route('instances.autosuspend', ['groupId'=>$id]) }}" enctype="multipart/form-data">
                        {{ csrf_field() }}
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <div class="radio">
                                            <label>
                                                <input type="radio" name="suspend-flag" id="suspend-flag1" value="enable">
                                                <b>Enable</b><br />Enable Auto Suspending of VMs.
                                            </label>
                                        </div>
                                        <div class="radio">
                                            <label>
                                                <input type="radio" name="suspend-flag" id="suspend-flag0" value="disable" checked>
                                                <b>Disable</b><br />Disable Auto Suspending of VMs.
                                            </label>
                                        </div>
                                    </div>
                                    <div id="team_auto_suspend_time" >
                                        <div class="form-group" width="10%">
                                            {{--<label><b>Name</b></label>--}}
                                            <b>Suspend VMs inactive for more than </b><input value="1" type="text" name="name" id="name" size="3"><b> days.</b> (Executed every midnight.)
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="modal-footer">
                            ...
                            <button id="btn-auto-suspend" type="submit" name="submit" value="submit" class="btn btn-primary"><i class="fa fa-check"></i>Set</button>
                        </div>
                    </form>
                </div>
            </div>
