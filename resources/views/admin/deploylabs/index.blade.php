        ...
        <div class="panel panel-default">
            <div class="panel-head table-responsive" style="margin-top: 15px">
                <div class="form-group">
                    ...
                    <button type="button" class="btn btn-primary" onclick="modal_assign_lab_contents($(this), '{{ url('labsdeploy/labcontents-table') }}')" title="Assign lab content for lab environment">Assign Lab Content</button>
                    <button type="button" class="btn btn-info" onclick="modal_update_labs(null)" title="Set lab's starting time and due day">Set Lab Working Time</button>
                    <button type="button" class="btn btn-success" onclick="deploy_labs($(this))" title="Allocate resources and deploy lab environment">Deploy Labs</button>
                    <button type="button" class="btn btn-warning" onclick="release_labs($(this))" title="Release and remove allocated resources">Release Resources</button>
                    <button type="button" class="btn btn-danger" onclick="delete_labs($(this))" title="Release allocated resources and delete labs">Delete Labs</button>
                    <button type="button" class="btn btn-primary" title="Assign more lab environments" id="assign_labs">Assign More Environments</button>
                </div>
            </div>
