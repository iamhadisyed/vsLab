...
class Router implements RegistrarContract, BindingRegistrar
{
    ...
    public function auth()
    {
        ...
        $this->get('userlogin', 'Auth\LoginController@showLoginForm')->name('login');
        $this->post('userlogin', 'Auth\LoginController@login');
        $this->post('logout', 'Auth\LoginController@logout')->name('logout');

        // Registration Routes...
        $this->get('userregister', 'Auth\RegisterController@showRegistrationForm')->name('register');
        $this->post('userregister', 'Auth\RegisterController@register');
