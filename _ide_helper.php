...
namespace Xavrsl\Cas\Facades {

    class Cas {

        public static function connection()
        {
            return \Xavrsl\Cas\CasManager::connection();
        }

        public static function isAuthenticated()
        {
            return \Xavrsl\Cas\Sso::isAuthenticated();
        }

        public static function getCurrentUser()
        {
            return \Xavrsl\Cas\Sso::getCurrentUser();
        }
    }
}
...
namespace Collective\Html { 
    ...
    class HtmlFacade {
         ...
         * @static 
         */ 
        public static function smart_tag($route, $text)
        {
            return \Collective\Html\HtmlBuilder::smart_tag($route, $text);
        }
...
namespace  { 
    ...
    class Cas extends \Xavrsl\Cas\Facades\Cas {}
