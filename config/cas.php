...
return [
    ...
    */
    'cas_hostname'        => env('CAS_HOSTNAME', 'weblogin.asu.edu'),
    ...
    */
    'cas_real_hosts'      => env('CAS_REAL_HOSTS', 'weblogin.asu.edu'),
    ...
    */
    'cas_validation'          => env('CAS_VALIDATION', 'https://weblogin.asu.edu/cas/serviceValidate'),
    ...
    */
    ...
    |--------------------------------------------------------------------------
    */
    'cas_logout_url'      => env('CAS_LOGOUT_URL', 'https://weblogin.asu.edu/cas/logout'),
