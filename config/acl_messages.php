...
return [
        "email" => [
            ...
            */
             ...
             */
            "user_registration_request_subject"     => "Registration request to: ThoTh Lab",
            /*
             * User activation
             */
            "user_registraction_activation_subject" => "Your user is activated on: ThoTh Lab",
            /*
        ...
        */
        "flash" => [
            ...
            "success" => [
                ...
                "custom_field_added"                   => "Field added successfully.",
                "custom_field_removed"                 => "Field removed successfully.",
                "avatar_edit_success"                  => "Avatar changed successfully",
                // group
                "group_edit_success"                   => "Group edited successfully.",
                "group_delete_success"                 => "Group deleted successfully.",
                "group_permission_edit_success"        => "Permission edited successfully.",
                // permission
